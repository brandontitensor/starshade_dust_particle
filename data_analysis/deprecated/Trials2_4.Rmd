...
Particles_AftTr4Sa1Surf <- read_csv("~/Desktop/College/Research/Trials/Surfaces/ImageJ Processed/AftTr4Sa1Surf/Particles_AftTr4Sa1Surf.csv")
Particles_AftTr4Sa2Surf <- read_csv("~/Desktop/College/Research/Trials/Surfaces/ImageJ Processed/AftTr4Sa2Surf/Particles_AftTr4Sa2Surf.csv")
Particles_AftTr4Sa3Surf <- read_csv("~/Desktop/College/Research/Trials/Surfaces/ImageJ Processed/AftTr4Sa3Surf/Particles_AftTr4Sa3Surf.csv")
Particles_AftTr4Sa4Surf <- read_csv("~/Desktop/College/Research/Trials/Surfaces/ImageJ Processed/AftTr4Sa4Surf/Particles_AftTr4Sa4Surf.csv")
Particles_AftTr4Sa5Surf <- read_csv("~/Desktop/College/Research/Trials/Surfaces/ImageJ Processed/AftTr4Sa5Surf/Particles_AftTr4Sa5Surf.csv")
...
Particles_BefTr5Sa1Surf <- read_csv("~/Desktop/College/Research/Trials/Trial_5/ImageJ Processed/BefTr5Sa1Surf/Particles_26_0_1_.csv")
Particles_BefTr5Sa2Surf <- read_csv("~/Desktop/College/Research/Trials/Trial_5/ImageJ Processed/BefTr5Sa2Surf/Particles_26_0_7_.csv")
...
Particles_AftTr4Sa1Surf  <- Particles_AftTr4Sa1Surf[,-c(1,15,16)]
Particles_AftTr4Sa2Surf  <- Particles_AftTr4Sa2Surf[,-c(1,15,16)]
Particles_AftTr4Sa3Surf  <- Particles_AftTr4Sa3Surf[,-c(1,15,16)]
Particles_AftTr4Sa4Surf  <- Particles_AftTr4Sa4Surf[,-c(1,15,16)]
Particles_AftTr4Sa5Surf  <- Particles_AftTr4Sa5Surf[,-c(1,15,16)]
...
Particles_BefTr4Sa1Surf  <- Particles_BefTr4Sa1Surf[,-c(1,15,16)]
Particles_BefTr4Sa2Surf  <- Particles_BefTr4Sa2Surf[,-c(1,15,16)]
Particles_BefTr4Sa3Surf  <- Particles_BefTr4Sa3Surf[,-c(1,15,16)]
Particles_BefTr4Sa4Surf  <- Particles_BefTr4Sa4Surf[,-c(1,15,16)]
Particles_BefTr4Sa5Surf  <- Particles_BefTr4Sa5Surf[,-c(1,15,16)]

Particles_BefTr5Sa1Surf  <- Particles_BefTr5Sa1Surf[,-c(1,15,16)]
Particles_BefTr5Sa2Surf  <- Particles_BefTr5Sa2Surf[,-c(1,15,16)]
...
Particles_BefTr5Sa1Surf$Diameter <- (sqrt(Particles_BefTr5Sa1Surf$Area/pi)*2)
Particles_BefTr5Sa2Surf$Diameter <- (sqrt(Particles_BefTr5Sa2Surf$Area/pi)*2)
...
Particles_AftTr4Sa1Surf$Diameter <- (sqrt(Particles_AftTr4Sa1Surf$Area/pi)*2)
Particles_AftTr4Sa2Surf$Diameter <- (sqrt(Particles_AftTr4Sa2Surf$Area/pi)*2)
Particles_AftTr4Sa3Surf$Diameter <- (sqrt(Particles_AftTr4Sa3Surf$Area/pi)*2)
Particles_AftTr4Sa4Surf$Diameter <- (sqrt(Particles_AftTr4Sa4Surf$Area/pi)*2)
Particles_AftTr4Sa5Surf$Diameter <- (sqrt(Particles_AftTr4Sa5Surf$Area/pi)*2)

#combined_before <- rbind(
                         # Particles_BefTr1Sa1Surf,
...
#combined_after <- rbind(
                         # Particles_AftTr1Sa1Surf,
...
combined_before4 <- rbind(Particles_BefTr4Sa1Surf,
                         Particles_BefTr4Sa2Surf,
                         Particles_BefTr4Sa3Surf,
                         Particles_BefTr4Sa4Surf,
                         Particles_BefTr4Sa5Surf)

combined_after4 <- rbind(Particles_AftTr4Sa1Surf,
                         Particles_AftTr4Sa2Surf,
                         Particles_AftTr4Sa3Surf,
                         Particles_AftTr4Sa4Surf,
                         Particles_AftTr4Sa5Surf)

combined_before5 <- rbind(Particles_BefTr5Sa1Surf,
                          Particles_BefTr5Sa2Surf)
...
```{r, echo=FALSE,warning=FALSE,message=FALSE}
# Create a sequence of diameter thresholds
diameter_thresholds <- seq(1, max(c( combined_before2$Diameter,
                                    combined_before3$Diameter, combined_after3$Diameter,
                                     combined_after2$Diameter)), by = 1)
...
for (i in seq_along(diameter_thresholds)) {
  ...
  counts_before4[i] <- sum(combined_before4$Diameter > threshold) *conversion
  ...
  counts_after4[i] <- sum(combined_after4$Diameter > threshold) *conversion
}
...
```{r}
# Create a sequence of diameter thresholds
diameter_thresholds <- seq(1, max(c(
                                    combined_before2$Diameter, combined_after2$Diameter)), by = 1)
...
# Create a sequence of diameter thresholds
diameter_thresholds <- seq(1, max(c(
  #Particles_BefTr1Sa1Surf$Diameter,
...
Area_thresholds <- seq(0, max(c(
  #Summary_BefTr1Sa1Surf$`Total Area`,
...
```{r, echo=FALSE,warning=FALSE,message=FALSE,eval=FALSE}
# Combine the data from combined_before and combined_after
combined_data <- rbind(combined_before2,combined_before3,combined_before4,combined_after2,combined_after3)
# Create a sequence of diameter thresholds
...
for (i in seq_along(diameter_thresholds)) {
  threshold <- diameter_thresholds[i]
  counts_before2[i] <- sum(combined_before2$Diameter > threshold)
  counts_before3[i] <- sum(combined_before3$Diameter > threshold)
  counts_before4[i] <- sum(combined_before4$Diameter > threshold)
  counts_after2[i] <- sum(combined_after2$Diameter > threshold)
  counts_after3[i] <- sum(combined_after3$Diameter > threshold)
}
# Create a data frame with the diameter thresholds and counts
plot_data <- data.frame(
...
# Calculate the difference between "Before" and "After" counts
trial2_diff <- plot_data$After2 - plot_data$Before2
trial3_diff <- plot_data$After3 - plot_data$Before3


# Combine the difference data into a single data frame
diff_data <- data.frame(
  Difference = c(trial2_diff, trial3_diff),
  Trial = c(rep("Trial 2", length(trial2_diff)),
            rep("Trial 3", length(trial3_diff)))
)

trials_data <- data.frame(
  Diameter = c(plot_data$Before2,plot_data$Before3,plot_data$Before4,plot_data$After2,plot_data$After3),
  Trial = c(rep("Before 2",length(plot_data$Before2)),
            rep("Before 3",length(plot_data$Before3)),
            rep("Before 4",length(plot_data$Before4)),
            rep("After 2",length(plot_data$After2)),
            rep("After 3",length(plot_data$After3))
            )
)

trial_data <- data.frame(
  Diameter = c(combined_before2$Diameter,combined_before3$Diameter,combined_before4$Diameter,combined_after2$Diameter,combined_after3$Diameter),
  Trial = c(rep("Before 2",length(combined_before2$Diameter)),
            rep("Before 3",length(combined_before3$Diameter)),
            rep("Before 4",length(combined_before4$Diameter)),
            rep("After 2",length(combined_after2$Diameter)),
            rep("After 3",length(combined_after3$Diameter))
            )
)

# Perform the Kruskal-Wallis test
kruskal_test_diff <- kruskal.test(Difference ~ Trial, data = diff_data)
kruskal_test_trials <- kruskal.test(Diameter ~ Trial, data = trials_data)
kruskal_test_trial <- kruskal.test(Diameter ~ Trial, data = trial_data)

# Print the Kruskal-Wallis test results
print(kruskal_test_diff)
print(kruskal_test_trials)
print(kruskal_test_trial)

# Perform the Dunn test for pairwise comparisons
library(FSA)
dunn_test_diff <- dunnTest(Difference ~ Trial, data = diff_data, method = "bonferroni")
dunn_test_trials <- dunnTest(Diameter ~ Trial, data = trials_data, method = "bonferroni")
dunn_test_trial <- dunnTest(Diameter ~ Trial, data = trial_data, method = "bonferroni")

# Print the Dunn test results
print(dunn_test_diff)
print(dunn_test_trial)
```

```{r}
# Assuming you have the data frames for each trial: trial2_before, trial3_before, trial4_before, trial2_after, trial3_after

trial2_before <- combined_before2
trial3_before <- combined_before3
trial4_before <- combined_before4
trial2_after <- combined_after2
trial3_after <- combined_after3

# Combine the data for before images of trials 2-4
before_data <- rbind(
  data.frame(Trial = "Trial 2", Diameter = trial2_before$Diameter),
  data.frame(Trial = "Trial 3", Diameter = trial3_before$Diameter),
  data.frame(Trial = "Trial 4", Diameter = trial4_before$Diameter)
)

# Perform ANOVA for before images of trials 2-4
before_anova <- aov(Diameter ~ Trial, data = before_data)
print(summary(before_anova))

# Combine the data for after images of trials 2-3
after_data <- rbind(
  data.frame(Trial = "Trial 2", Diameter = trial2_after$Diameter),
  data.frame(Trial = "Trial 3", Diameter = trial3_after$Diameter)
)

# Perform ANOVA for after images of trials 2-3
after_anova <- aov(Diameter ~ Trial, data = after_data)
print(summary(after_anova))

# Perform paired t-tests for the difference between before and after images for trials 2-3
trial2_diff <- trial2_after$Diameter - trial2_before$Diameter
trial3_diff <- trial3_after$Diameter - trial3_before$Diameter

# Perform paired t-test for trial 2
trial2_ttest <- t.test(trial2_diff)
print(trial2_ttest)

# Perform paired t-test for trial 3
trial3_ttest <- t.test(trial3_diff)
print(trial3_ttest)
```
...
# Combine the data for before images of trials 2-4
before_data <- rbind(
  data.frame(Trial = "Trial 2", Diameter = combined_before2$Diameter),
  data.frame(Trial = "Trial 3", Diameter = combined_before3$Diameter)
  #data.frame(Trial = "Trial 4", Diameter = combined_before4$Diameter)
)
...
# Combine the data for after images of trials 2-3
after_data <- rbind(
  data.frame(Trial = "Trial 2", Diameter = combined_after2$Diameter),
  data.frame(Trial = "Trial 3", Diameter = combined_after3$Diameter)
)
...
t.test(Diameter ~ Trial, data = before_data)
# 
# # Perform paired t-tests for the difference between before and after images for trials 2-3
# trial2_diff <- combined_after2$Diameter - trial2_before$Diameter
# trial3_diff <- combined_after2$Diameter - trial3_before$Diameter
# 
# # Perform paired t-test for trial 2
# trial2_ttest <- t.test(trial2_diff)
# print(trial2_ttest)
...
```{r}
# Combine the data from combined_before and combined_after
combined_data <- rbind(combined_before2, combined_before3, combined_before4,combined_before5)
# Create a sequence of diameter thresholds
diameter_thresholds <- seq(1, max(combined_data$Diameter), by = .01)
# Initialize vectors to store the counts for each diameter threshold
counts_before2 <- numeric(length(diameter_thresholds))
counts_before3 <- numeric(length(diameter_thresholds))
counts_before4 <- numeric(length(diameter_thresholds))
...
for (i in seq_along(diameter_thresholds)) {
  ...
  counts_before3[i] <- sum(combined_before3$Diameter > threshold) * conversion
  counts_before4[i] <- sum(combined_before4$Diameter > threshold) * conversion
  counts_before5[i] <- sum(combined_before4$Diameter > threshold) * 2 * conversion
}
# Create a data frame with the diameter thresholds and counts
plot_data <- data.frame(
  Diameter = (log10(diameter_thresholds)^2),
...
ggplot(plot_data_long, aes(x = Diameter, y = Count, color = Group)) +
  ...
  scale_y_log10() +  # Apply logarithmic scale to the y-axis
  labs(x = "Diameter(log(microns)^2)", y = "Count of Particles (log scale)",
       title = "Count of Particles Greater Than Diameter(microns): Before Trials 2-5 per .1m^2") +
  theme_minimal() 
```
...
# Combine the data from combined_before and combined_after
combined_data <- rbind(combined_before2, combined_after2, combined_before3, combined_after3, combined_before4, combined_after4)
...
L4 <- 10^(sqrt((log10((sum(combined_after4$Diameter >=
                            max(combined_after4$Diameter)))*conversion)/-slope) + 
      (log10(max(combined_after4$Diameter))^2)))

L4b <- 10^(sqrt((log10((sum(combined_before4$Diameter >=
                            max(combined_before4$Diameter)))*conversion)/-slope) + 
      (log10(max(combined_before4$Diameter))^2)))
